...
to z=z_max. It does so by iterating through snapshots, filtering for all 
galaxies within the shell corresponding to a snapshot Getting galaxies from 
the entire sky becomes extremely expensive (>10Gb of memory around z=0.1).
